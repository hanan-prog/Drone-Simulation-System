 ...
 * generating the DFS path to move an entity in the simulation.
 */
class DfsStrategy : public IStrategy {
 public:
  /**
   * @brief Using the DfsStrategy path finding algorithm, it calculates the
  ...
  /**
   * @brief Moves entity toward next node/position using the DFS path
   *
